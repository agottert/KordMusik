      ...
      <div>
        ...
        <div className="wrapper">
          <div className="wrapper_header">
            <div>
              <img className="pic_logo"src="../../static/Images/Kord Music.png" />
            </div>
            <span className="slogan">Film Scoring for the World</span>
            </div>
            <div className="wrapper_actions">
              <a className="header_about" href="#about">
                About
              </a>
            ...
            <div id="about" className="wrapper_about">
              ...
              audiovisuales. Los servicios musicales que brinda la productora
              son acompañar, conectar, unificar, realzar, dar vida y color a
              cada obra artística audiovisual. Trabajamos con un equipo musical
              que garantiza por sobre todo escuchar las ideas de cada creador
              para asegurar la mejor y más original pieza musica
            </div>
            <PlayBreaks />
            {
            ...
            <div id="contact" className="wrapper_contact">
              ...
              <div className="wrapper_mail">
                ...
                <a className="svg_mail--a"href="mailto:kordmusik@gmail.com">kordmusik@gmail.com</a>
